...
public static class DelegateFeatureSlice
{
    public static class Default<TRequest, TResponse>
    {
        ...
        public static void Register<TDispatch>(IServiceCollection services, Func<IServiceProvider, Dispatch> dispatcher, DispatchConverter<TDispatch> converter)
            where TDispatch : Delegate
        {
    ...
    {       
        ...
        public static void Register<TFlag, TDispatch>(IServiceCollection services, Func<IServiceProvider, Dispatch> dispatcher, DispatchConverter<TDispatch> converter)
